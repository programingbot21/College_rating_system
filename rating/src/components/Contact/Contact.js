...
function Contact() {
  ...
  <div className="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
    ...
    <div className="bg-gray-100 p-6 rounded-lg">
      <p className="text-sm font-semibold text-gray-800">Our College interested in...</p>
    {/* <img src='https://img.freepik.com/free-photo/flat-lay-chat-bubbles-with-telephone-receiver-copy-space_23-2148796079.jpg?ga=GA1.1.731215008.1735820669&semt=ais_hybrid' alt=''/> */}
      <img src='https://img.freepik.com/free-vector/call-center-operators-carrying-communication-icons_53876-64652.jpg?ga=GA1.1.731215008.1735820669&semt=ais_hybrid' alt=''/>
      {/* <div className="space-y-4 max-lg:mt-4">
        <button type="button" className="px-4 py-2 rounded-lg bg-[#a91079] text-white text-sm tracking-wider font-medium outline-none border-2 border-[#a91079] mr-4">New Experiment</button>
        <button type="button" className="px-4 py-2 rounded-lg bg-[#1064a9] text-white text-sm tracking-wider font-medium outline-none border-2 border-gray-300 mr-4">CSE</button>
        <button type="button" className="px-4 py-2 rounded-lg bg-[#1d3c19] text-white text-sm tracking-wider font-medium outline-none border-2 border-gray-300">IT</button>
        <button type="button" className="px-4 py-2 rounded-lg bg-[#5b395b] text-white text-sm tracking-wider font-medium outline-none border-2 border-gray-300">AI</button>
      ...
      {/* <form className="mt-8 space-y-4">
        ...
        <input type="text" placeholder="Subject" className="w-full rounded-lg py-3 px-4 text-gray-800 text-sm outline-[#a91079]" />
        <textarea placeholder="Message" rows={6} className="w-full rounded-lg px-4 text-gray-800 text-sm pt-3 outline-[#a91079]" defaultValue={""} />

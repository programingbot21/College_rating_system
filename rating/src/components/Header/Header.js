            ...
            <nav className="bg-blue-950 border-gray-200 px-4 lg:px-6 py-2.5">
                ...
                mx-auto max-w-screen-xl">
                    <Link to="/" className="flex items-center">
                        <img
                            src="https://img.freepik.com/premium-vector/education-school-college-university-institute-logo-design_692083-429.jpg?semt=ais_hybrid"
                            className="mr-1 h-20 "
                            alt="Logo"
                        />
                    </Link>
                    <div className="flex items-center lg:order-2">
                        <Link
                            ...
                            className="text-white hover:bg-red-500
                             focus:ring-4 focus:ring-gray-500 font-medium 
                         ...
                         lg:flex-row lg:space-x-8 lg:mt-0">
                                    ...
                                    className={({isActive}) =>
                                        ...
                                        ${isActive ? "text-orange-700" : "text-white"}
                                         border-b border-gray-100
                                          hover:bg-gray-500 lg:hover:bg-transparent
                            ...
                            <li>
                                <NavLink to='/about'
                                    className={({isActive}) =>
                                        ...
                                        ${isActive ? "text-orange-700" : "text-white"}
                                         border-b border-gray-100
                                          hover:bg-white-700 lg:hover:bg-transparent
                                           lg:border-0 hover:text-orange-700 
                                           lg:p-0`
                                    }
                                >
                            ...
                            <li>
                                <NavLink to='/contact-us'
                                    className={({isActive}) =>
                                        `block py-2 pr-4 pl-3 duration-200 font-300
                                        ${isActive ? "text-orange-700" : "text-white"}
                                         border-b border-gray-100
